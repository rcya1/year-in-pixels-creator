...
const getItemColorPreviewStyle = (colorScheme) => ({
  backgroundColor:
    "rgb(" + colorScheme[0] + "," + colorScheme[1] + "," + colorScheme[2] + ")",
...
class ColorSchemeList extends React.Component {
  ...
  onDragEnd = (result) => {
    ...
    this.props.changeColorSchemeOrder(
      result.source.index,
      ...
      <OverlayTrigger
        overlay={
          <Tooltip id="tooltip-disabled">
            Create an account to use custom color schemes!
          </Tooltip>
        }
      >
                  ...
                  {this.props.colorSchemes.map((colorScheme, index) => {
                    return (
                      <Draggable
                        ...
                        index={index}
                        isDragDisabled={
                          this.props.disabled || this.props.exportPreview
                        }
                      >
                        {(provided, snapshot) => (
                          <div
                          ...
                          >
                            <Container>
                              <Row>
                                <span
                                  style={getItemColorPreviewStyle(colorScheme)}
                                >
                                  {" "}
                                </span>
                                <p
                                  className="mr-auto my-auto text-truncate"
...
export default React.forwardRef((props, ref) => (
  <ColorSchemeList innerRef={ref} {...props} />
));
