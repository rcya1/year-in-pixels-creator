...
export class SBSControls extends React.Component {
  ...
  render() {
    ...
    if (
      this.props.data.colorsRef.current != null &&
      this.props.data.colRef.current != null
    ) {
      ...
      maxWidth = Math.floor(
        ((colRect.width - this.props.config.colorsLeftMargin) * 100.0) /
          colRect.width
      );
    }
    ...
    return (
      <React.Fragment>
        <Form.Group>
          <Form.Label as="h5">Colors Top Margin (px)</Form.Label>
        ...
        <Form.Group>
          <Form.Label as="h5">Colors Left Margin (px)</Form.Label>
          <InputGroup className="justify-content-center mt-3">
            <ReactBootstrapSlider
        ...
        <Form.Group>
          <Form.Label as="h5">Colors Width (%)</Form.Label>
          <InputGroup className="justify-content-center mt-3">
            <ReactBootstrapSlider
        ...
        <Form.Group>
          <Form.Label as="h5">Board Width (%)</Form.Label>
          <InputGroup className="justify-content-center mt-3">
            <ReactBootstrapSlider
