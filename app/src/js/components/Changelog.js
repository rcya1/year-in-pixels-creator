    ...
    return (
      <Container>
        ...
        <ul className={paragraphClassName}>
          ...
          <li>
            Add new default calendar view that can be accessed in the settings
          </li>
          <li>Add limit on username length</li>
          <li>Fix transparent backgrounds on exported PNG images</li>
          <li>
            Added sizing control for exporting images in the side by side layout
          </li>
        </ul>
        <h3 className={headerClassName}>v1.2</h3>
        <ul className={paragraphClassName}>
          <li>
            Added the ability to export board images as SVG, PNG, and PDF files
          </li>
          <li>
            Added new day menu system that should hopefully be more stable and
            less prone to flickering or crashing
          </li>
          <li>Added the ability to delete years</li>
          <li>
            Add toolbar for the new select current day button and the exporting
            feature
          </li>
        </ul>
        ...
        <ul className={paragraphClassName}>
          ...
          <li>
            Add loading bar indicator for updating the user on what operations
            are occurring
          </li>
          <li>
            Add the ability to export all account data in a JSON format (WIP,
            cannot import data)
          </li>
          ...
          <li>
            Fixed bug where dragging in the day menu would result in closing the
            menu
          </li>
        </ul>
